...
namespace Apache.Cassandra
{
  ...
  public partial class CfDef : TBase
  {
    ...
    private string _cells_per_row_to_cache;
    private int _min_index_interval;
    private int _max_index_interval;
    ...
    public string Cells_per_row_to_cache
    {
      get
      {
        return _cells_per_row_to_cache;
      }
      set
      {
        __isset.cells_per_row_to_cache = true;
        this._cells_per_row_to_cache = value;
      }
    }
    ...
    public int Min_index_interval
    {
      get
      {
        return _min_index_interval;
      }
      set
      {
        __isset.min_index_interval = true;
        this._min_index_interval = value;
      }
    }
    ...
    public int Max_index_interval
    {
      get
      {
        return _max_index_interval;
      }
      set
      {
        __isset.max_index_interval = true;
        this._max_index_interval = value;
      }
    }
    ...
    public struct Isset {
      ...
      public bool cells_per_row_to_cache;
      public bool min_index_interval;
      public bool max_index_interval;
    ...
    public CfDef() {
      ...
      this._cells_per_row_to_cache = "100";
      ...
      try
      {
        ...
        while (true)
        {
          ...
          switch (field.ID)
          {
            ...
            case 44:
              if (field.Type == TType.String) {
                Cells_per_row_to_cache = iprot.ReadString();
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
              break;
            case 45:
              if (field.Type == TType.I32) {
                Min_index_interval = iprot.ReadI32();
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
              break;
            case 46:
              if (field.Type == TType.I32) {
                Max_index_interval = iprot.ReadI32();
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
              break;
    ...
    public void Write(TProtocol oprot) {
      ...
      try
      {
        ...
        if (Cells_per_row_to_cache != null && __isset.cells_per_row_to_cache) {
          field.Name = "cells_per_row_to_cache";
          field.Type = TType.String;
          field.ID = 44;
          oprot.WriteFieldBegin(field);
          oprot.WriteString(Cells_per_row_to_cache);
          oprot.WriteFieldEnd();
        }
        if (__isset.min_index_interval) {
          field.Name = "min_index_interval";
          field.Type = TType.I32;
          field.ID = 45;
          oprot.WriteFieldBegin(field);
          oprot.WriteI32(Min_index_interval);
          oprot.WriteFieldEnd();
        }
        if (__isset.max_index_interval) {
          field.Name = "max_index_interval";
          field.Type = TType.I32;
          field.ID = 46;
          oprot.WriteFieldBegin(field);
          oprot.WriteI32(Max_index_interval);
          oprot.WriteFieldEnd();
        }
    ...
    public override string ToString() {
      ...
      if (__isset.dclocal_read_repair_chance) {
        __sb.Append(", Dclocal_read_repair_chance: ");
        __sb.Append(Dclocal_read_repair_chance);
      }
      if (__isset.memtable_flush_period_in_ms) {
        __sb.Append(", Memtable_flush_period_in_ms: ");
        __sb.Append(Memtable_flush_period_in_ms);
      }
      if (__isset.default_time_to_live) {
        __sb.Append(", Default_time_to_live: ");
        __sb.Append(Default_time_to_live);
      }
      if (Speculative_retry != null && __isset.speculative_retry) {
        __sb.Append(", Speculative_retry: ");
        __sb.Append(Speculative_retry);
      }
      if (Triggers != null && __isset.triggers) {
      ...
      if (Cells_per_row_to_cache != null && __isset.cells_per_row_to_cache) {
        __sb.Append(", Cells_per_row_to_cache: ");
        __sb.Append(Cells_per_row_to_cache);
      }
      if (__isset.min_index_interval) {
        __sb.Append(", Min_index_interval: ");
        __sb.Append(Min_index_interval);
      }
      if (__isset.max_index_interval) {
        __sb.Append(", Max_index_interval: ");
        __sb.Append(Max_index_interval);
      }
      if (__isset.row_cache_size) {
        __sb.Append(", Row_cache_size: ");
        __sb.Append(Row_cache_size);
      }
      if (__isset.key_cache_size) {
        __sb.Append(", Key_cache_size: ");
        __sb.Append(Key_cache_size);
      }
      if (__isset.row_cache_save_period_in_seconds) {
        __sb.Append(", Row_cache_save_period_in_seconds: ");
        __sb.Append(Row_cache_save_period_in_seconds);
      }
      if (__isset.key_cache_save_period_in_seconds) {
        __sb.Append(", Key_cache_save_period_in_seconds: ");
        __sb.Append(Key_cache_save_period_in_seconds);
      }
      if (__isset.memtable_flush_after_mins) {
        __sb.Append(", Memtable_flush_after_mins: ");
        __sb.Append(Memtable_flush_after_mins);
      }
      if (__isset.memtable_throughput_in_mb) {
        __sb.Append(", Memtable_throughput_in_mb: ");
        __sb.Append(Memtable_throughput_in_mb);
      }
      if (__isset.memtable_operations_in_millions) {
        __sb.Append(", Memtable_operations_in_millions: ");
        __sb.Append(Memtable_operations_in_millions);
      }
      if (__isset.replicate_on_write) {
      ...
      if (Row_cache_provider != null && __isset.row_cache_provider) {
        __sb.Append(", Row_cache_provider: ");
        __sb.Append(Row_cache_provider);
      }
      if (__isset.row_cache_keys_to_save) {
        __sb.Append(", Row_cache_keys_to_save: ");
        __sb.Append(Row_cache_keys_to_save);
      }
      if (__isset.populate_io_cache_on_flush) {
        __sb.Append(", Populate_io_cache_on_flush: ");
        __sb.Append(Populate_io_cache_on_flush);
      }
      if (__isset.index_interval) {
        __sb.Append(", Index_interval: ");
        __sb.Append(Index_interval);
      }
      __sb.Append(")");
