...
namespace Apache.Cassandra
{
  internal partial class Cassandra {
    internal interface ISync {
      ...
      /// <param name="serial_consistency_level"></param>
      /// <param name="commit_consistency_level"></param>
      CASResult cas(byte[] key, string column_family, List<Column> expected, List<Column> updates, ConsistencyLevel serial_consistency_level, ConsistencyLevel commit_consistency_level);
      /// <summary>
      ...
      List<ColumnOrSuperColumn> get_multi_slice(MultiSliceRequest request);
      /// <summary>
      ...
      /// </summary>
      /// <param name="keyspace"></param>
      List<TokenRange> describe_local_ring(string keyspace);
      /// <summary>
    ...
    internal interface Iface : ISync {
      ...
      /// <param name="commit_consistency_level"></param>
      #if SILVERLIGHT
      IAsyncResult Begin_cas(AsyncCallback callback, object state, byte[] key, string column_family, List<Column> expected, List<Column> updates, ConsistencyLevel serial_consistency_level, ConsistencyLevel commit_consistency_level);
      CASResult End_cas(IAsyncResult asyncResult);
      #endif
      /// <summary>
      /// Remove data from the row specified by key at the granularity specified by column_path, and the given timestamp. Note
      /// that all the values in column_path besides column_path.column_family are truly optional: you can remove the entire
      ...
      /// <param name="request"></param>
      #if SILVERLIGHT
      IAsyncResult Begin_get_multi_slice(AsyncCallback callback, object state, MultiSliceRequest request);
      List<ColumnOrSuperColumn> End_get_multi_slice(IAsyncResult asyncResult);
      #endif
      /// <summary>
      /// for each schema version present in the cluster, returns a list of nodes at that version.
      /// hosts that do not respond will be under the key DatabaseDescriptor.INITIAL_VERSION.
      ...
      /// <param name="keyspace"></param>
      #if SILVERLIGHT
      IAsyncResult Begin_describe_local_ring(AsyncCallback callback, object state, string keyspace);
      List<TokenRange> End_describe_local_ring(IAsyncResult asyncResult);
      #endif
      /// <summary>
      /// get the mapping between token->node ip
      /// without taking replication into consideration
    ...
    internal class Client : IDisposable, Iface {
      ...
      public IAsyncResult Begin_cas(AsyncCallback callback, object state, byte[] key, string column_family, List<Column> expected, List<Column> updates, ConsistencyLevel serial_consistency_level, ConsistencyLevel commit_consistency_level)
      {
        return send_cas(callback, state, key, column_family, expected, updates, serial_consistency_level, commit_consistency_level);
      }

      public CASResult End_cas(IAsyncResult asyncResult)
      {
        oprot_.Transport.EndFlush(asyncResult);
        return recv_cas();
      }
      ...
      /// <param name="serial_consistency_level"></param>
      /// <param name="commit_consistency_level"></param>
      public CASResult cas(byte[] key, string column_family, List<Column> expected, List<Column> updates, ConsistencyLevel serial_consistency_level, ConsistencyLevel commit_consistency_level)
      {
        #if SILVERLIGHT
        var asyncResult = Begin_cas(null, null, key, column_family, expected, updates, serial_consistency_level, commit_consistency_level);
        return End_cas(asyncResult);
      ...
      #if SILVERLIGHT
      public IAsyncResult send_cas(AsyncCallback callback, object state, byte[] key, string column_family, List<Column> expected, List<Column> updates, ConsistencyLevel serial_consistency_level, ConsistencyLevel commit_consistency_level)
      {
      ...
      public void send_cas(byte[] key, string column_family, List<Column> expected, List<Column> updates, ConsistencyLevel serial_consistency_level, ConsistencyLevel commit_consistency_level)
      {
        oprot_.WriteMessageBegin(new TMessage("cas", TMessageType.Call, seqid_));
        cas_args args = new cas_args();
        args.Key = key;
      ...
      public CASResult recv_cas()
      {
        ...
        throw new TApplicationException(TApplicationException.ExceptionType.MissingResult, "cas failed: unknown result");
      }
      ...
      public IAsyncResult Begin_get_multi_slice(AsyncCallback callback, object state, MultiSliceRequest request)
      {
        return send_get_multi_slice(callback, state, request);
      }

      public List<ColumnOrSuperColumn> End_get_multi_slice(IAsyncResult asyncResult)
      {
        oprot_.Transport.EndFlush(asyncResult);
      ...
      {
        #if SILVERLIGHT
        var asyncResult = Begin_get_multi_slice(null, null, request);
        return End_get_multi_slice(asyncResult);
      ...
      #if SILVERLIGHT
      public IAsyncResult send_get_multi_slice(AsyncCallback callback, object state, MultiSliceRequest request)
      {
        oprot_.WriteMessageBegin(new TMessage("get_multi_slice", TMessageType.Call, seqid_));
      ...
      public void send_get_multi_slice(MultiSliceRequest request)
      {
        oprot_.WriteMessageBegin(new TMessage("get_multi_slice", TMessageType.Call, seqid_));
        get_multi_slice_args args = new get_multi_slice_args();
        args.Request = request;
      ...
      public List<ColumnOrSuperColumn> recv_get_multi_slice()
      {
        TMessage msg = iprot_.ReadMessageBegin();
        if (msg.Type == TMessageType.Exception) {
          TApplicationException x = TApplicationException.Read(iprot_);
        ...
        throw new TApplicationException(TApplicationException.ExceptionType.MissingResult, "get_multi_slice failed: unknown result");
      }
      ...
      public IAsyncResult Begin_describe_local_ring(AsyncCallback callback, object state, string keyspace)
      {
        return send_describe_local_ring(callback, state, keyspace);
      }

      public List<TokenRange> End_describe_local_ring(IAsyncResult asyncResult)
      {
        oprot_.Transport.EndFlush(asyncResult);
      ...
      /// </summary>
      /// <param name="keyspace"></param>
      public List<TokenRange> describe_local_ring(string keyspace)
      {
        #if SILVERLIGHT
        var asyncResult = Begin_describe_local_ring(null, null, keyspace);
        return End_describe_local_ring(asyncResult);
      ...
      #if SILVERLIGHT
      public IAsyncResult send_describe_local_ring(AsyncCallback callback, object state, string keyspace)
      {
        oprot_.WriteMessageBegin(new TMessage("describe_local_ring", TMessageType.Call, seqid_));
      ...
      public void send_describe_local_ring(string keyspace)
      {
        oprot_.WriteMessageBegin(new TMessage("describe_local_ring", TMessageType.Call, seqid_));
        describe_local_ring_args args = new describe_local_ring_args();
        args.Keyspace = keyspace;
      ...
      public List<TokenRange> recv_describe_local_ring()
      {
        TMessage msg = iprot_.ReadMessageBegin();
        if (msg.Type == TMessageType.Exception) {
          TApplicationException x = TApplicationException.Read(iprot_);
        ...
        throw new TApplicationException(TApplicationException.ExceptionType.MissingResult, "describe_local_ring failed: unknown result");
      }
    ...
    internal class Processor : TProcessor {
      public Processor(ISync iface)
      {
        ...
        processMap_["get_multi_slice"] = get_multi_slice_Process;
        ...
        processMap_["describe_local_ring"] = describe_local_ring_Process;
      ...
      public void get_paged_slice_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        catch (Exception ex)
        {
          ...
          Console.Error.WriteLine(ex.ToString());
          TApplicationException x = new TApplicationException        (TApplicationException.ExceptionType.InternalError," Internal error.");
          oprot.WriteMessageBegin(new TMessage("get_paged_slice", TMessageType.Exception, seqid));
          x.Write(oprot);
        }
        oprot.WriteMessageEnd();
        oprot.Transport.Flush();
      ...
      public void cas_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        catch (Exception ex)
        {
          ...
          Console.Error.WriteLine(ex.ToString());
          TApplicationException x = new TApplicationException        (TApplicationException.ExceptionType.InternalError," Internal error.");
          oprot.WriteMessageBegin(new TMessage("cas", TMessageType.Exception, seqid));
          x.Write(oprot);
        }
        oprot.WriteMessageEnd();
        oprot.Transport.Flush();
      ...
      public void atomic_batch_mutate_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        catch (Exception ex)
        {
          ...
          Console.Error.WriteLine(ex.ToString());
          TApplicationException x = new TApplicationException        (TApplicationException.ExceptionType.InternalError," Internal error.");
          oprot.WriteMessageBegin(new TMessage("atomic_batch_mutate", TMessageType.Exception, seqid));
          x.Write(oprot);
        }
        oprot.WriteMessageEnd();
        oprot.Transport.Flush();
      ...
      public void get_multi_slice_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        get_multi_slice_args args = new get_multi_slice_args();
        args.Read(iprot);
        iprot.ReadMessageEnd();
        ...
        try
        {
          try
          {
            result.Success = iface_.get_multi_slice(args.Request);
          }
          catch (InvalidRequestException ire)
          {
            result.Ire = ire;
          ...
          oprot.WriteMessageBegin(new TMessage("get_multi_slice", TMessageType.Reply, seqid)); 
          result.Write(oprot);
        }
        catch (TTransportException)
        {
        ...
        catch (Exception ex)
        {
          ...
          Console.Error.WriteLine(ex.ToString());
          TApplicationException x = new TApplicationException        (TApplicationException.ExceptionType.InternalError," Internal error.");
          oprot.WriteMessageBegin(new TMessage("get_multi_slice", TMessageType.Exception, seqid));
          x.Write(oprot);
        }
        oprot.WriteMessageEnd();
        oprot.Transport.Flush();
      ...
      public void describe_local_ring_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        describe_local_ring_args args = new describe_local_ring_args();
        args.Read(iprot);
        iprot.ReadMessageEnd();
        ...
        try
        {
          try
          {
            result.Success = iface_.describe_local_ring(args.Keyspace);
          }
          catch (InvalidRequestException ire)
          {
            result.Ire = ire;
          }
          oprot.WriteMessageBegin(new TMessage("describe_local_ring", TMessageType.Reply, seqid)); 
          result.Write(oprot);
        }
        catch (TTransportException)
        {
        ...
        catch (Exception ex)
        {
          ...
          Console.Error.WriteLine(ex.ToString());
          TApplicationException x = new TApplicationException        (TApplicationException.ExceptionType.InternalError," Internal error.");
          oprot.WriteMessageBegin(new TMessage("describe_local_ring", TMessageType.Exception, seqid));
          x.Write(oprot);
        }
        oprot.WriteMessageEnd();
        oprot.Transport.Flush();
      ...
      public void describe_token_map_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        catch (Exception ex)
        {
          ...
          Console.Error.WriteLine(ex.ToString());
          TApplicationException x = new TApplicationException        (TApplicationException.ExceptionType.InternalError," Internal error.");
          oprot.WriteMessageBegin(new TMessage("describe_token_map", TMessageType.Exception, seqid));
          x.Write(oprot);
        }
        oprot.WriteMessageEnd();
        oprot.Transport.Flush();
      ...
      public void trace_next_query_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        catch (Exception ex)
        {
          ...
          Console.Error.WriteLine(ex.ToString());
          TApplicationException x = new TApplicationException        (TApplicationException.ExceptionType.InternalError," Internal error.");
          oprot.WriteMessageBegin(new TMessage("trace_next_query", TMessageType.Exception, seqid));
          x.Write(oprot);
        }
        oprot.WriteMessageEnd();
        oprot.Transport.Flush();
      ...
      public void describe_splits_ex_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        catch (Exception ex)
        {
          ...
          Console.Error.WriteLine(ex.ToString());
          TApplicationException x = new TApplicationException        (TApplicationException.ExceptionType.InternalError," Internal error.");
          oprot.WriteMessageBegin(new TMessage("describe_splits_ex", TMessageType.Exception, seqid));
          x.Write(oprot);
        }
        oprot.WriteMessageEnd();
        oprot.Transport.Flush();
      ...
      public void execute_cql3_query_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        catch (Exception ex)
        {
          ...
          Console.Error.WriteLine(ex.ToString());
          TApplicationException x = new TApplicationException        (TApplicationException.ExceptionType.InternalError," Internal error.");
          oprot.WriteMessageBegin(new TMessage("execute_cql3_query", TMessageType.Exception, seqid));
          x.Write(oprot);
        }
        oprot.WriteMessageEnd();
        oprot.Transport.Flush();
      ...
      public void prepare_cql3_query_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        catch (Exception ex)
        {
          ...
          Console.Error.WriteLine(ex.ToString());
          TApplicationException x = new TApplicationException        (TApplicationException.ExceptionType.InternalError," Internal error.");
          oprot.WriteMessageBegin(new TMessage("prepare_cql3_query", TMessageType.Exception, seqid));
          x.Write(oprot);
        }
        oprot.WriteMessageEnd();
        oprot.Transport.Flush();
      ...
      public void execute_prepared_cql3_query_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        catch (Exception ex)
        {
          ...
          Console.Error.WriteLine(ex.ToString());
          TApplicationException x = new TApplicationException        (TApplicationException.ExceptionType.InternalError," Internal error.");
          oprot.WriteMessageBegin(new TMessage("execute_prepared_cql3_query", TMessageType.Exception, seqid));
          x.Write(oprot);
        }
        oprot.WriteMessageEnd();
        oprot.Transport.Flush();
      ...
      public void set_cql_version_Process(int seqid, TProtocol iprot, TProtocol oprot)
      {
        ...
        catch (Exception ex)
        {
          ...
          Console.Error.WriteLine(ex.ToString());
          TApplicationException x = new TApplicationException        (TApplicationException.ExceptionType.InternalError," Internal error.");
          oprot.WriteMessageBegin(new TMessage("set_cql_version", TMessageType.Exception, seqid));
          x.Write(oprot);
        }
        oprot.WriteMessageEnd();
        oprot.Transport.Flush();
      ...
      public void Read (TProtocol iprot)
      {
        ...
        try
        {
          ...
          if (!isset_auth_request)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Auth_request not set");
        }
        finally
        {
    ...
    internal partial class set_keyspace_args : TBase
    {
      ...
      public void Read (TProtocol iprot)
      {
        ...
        try
        {
          ...
          iprot.ReadStructEnd();
          if (!isset_keyspace)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Keyspace not set");
        }
        finally
        {
          iprot.DecrementRecursionDepth();
      ...
      public void Read (TProtocol iprot)
      {
        ...
        try
        {
          ...
          if (!isset_column_path)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Column_path not set");
          if (!isset_consistency_level)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Consistency_level not set");
        }
        finally
        {
          iprot.DecrementRecursionDepth();
      ...
      public void Read (TProtocol iprot)
      {
        ...
        try
        {
          ...
          if (!isset_column_parent)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Column_parent not set");
          if (!isset_predicate)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Predicate not set");
          if (!isset_consistency_level)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Consistency_level not set");
        }
        finally
                ...
                if (field.Type == TType.List) {
                  {
                    ...
                    {
                      ColumnOrSuperColumn _elem114;
                      _elem114 = new ColumnOrSuperColumn();
                      _elem114.Read(iprot);
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              oprot.WriteFieldBegin(field);
              {
                ...
                foreach (ColumnOrSuperColumn _iter115 in Success)
                {
    ...
    internal partial class multiget_slice_args : TBase
    {
      ...
      public void Read (TProtocol iprot)
      {
        ...
        try
        {
          ...
          iprot.ReadStructEnd();
          if (!isset_keys)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Keys not set");
          if (!isset_column_parent)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Column_parent not set");
          if (!isset_predicate)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Predicate not set");
                ...
                if (field.Type == TType.Map) {
                  {
                    ...
                    {
                      byte[] _key122;
                      List<ColumnOrSuperColumn> _val123;
                      _key122 = iprot.ReadBinary();
                      {
                        _val123 = new List<ColumnOrSuperColumn>();
                        TList _list124 = iprot.ReadListBegin();
                        for( int _i125 = 0; _i125 < _list124.Count; ++_i125)
                        {
                          ColumnOrSuperColumn _elem126;
                          _elem126 = new ColumnOrSuperColumn();
                          _elem126.Read(iprot);
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              oprot.WriteFieldBegin(field);
              {
                ...
                foreach (byte[] _iter127 in Success.Keys)
                {
                  oprot.WriteBinary(_iter127);
                  {
                    oprot.WriteListBegin(new TList(TType.Struct, Success[_iter127].Count));
                    foreach (ColumnOrSuperColumn _iter128 in Success[_iter127])
                    {
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              oprot.WriteFieldBegin(field);
              {
                ...
                foreach (byte[] _iter137 in Success.Keys)
                {
                  oprot.WriteBinary(_iter137);
                  oprot.WriteI32(Success[_iter137]);
                }
                oprot.WriteMapEnd();
              }
              oprot.WriteFieldEnd();
      ...
      public void Read (TProtocol iprot)
      {
        ...
        try
        {
          ...
          if (!isset_predicate)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Predicate not set");
          if (!isset_range)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Range not set");
          if (!isset_consistency_level)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Consistency_level not set");
        }
        finally
        ...
        try
        {
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              {
                oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
                foreach (KeySlice _iter141 in Success)
                {
    ...
    internal partial class get_paged_slice_args : TBase
    {
      ...
      public byte[] Start_column { get; set; }
      ...
      public get_paged_slice_args(string column_family, KeyRange range, byte[] start_column, ConsistencyLevel consistency_level) : this() {
      ...
      public void Read (TProtocol iprot)
      {
        ...
        try
        {
          ...
          if (!isset_start_column)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Start_column not set");
          if (!isset_consistency_level)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Consistency_level not set");
        }
        finally
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("get_paged_slice_args(");
    ...
    internal partial class get_paged_slice_result : TBase
    {
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("get_paged_slice_result(");
        bool __first = true;
        if (Success != null && __isset.success) {
          if(!__first) { __sb.Append(", "); }
          __first = false;
      ...
      public void Read (TProtocol iprot)
      {
        ...
        try
        {
          ...
          if (!isset_index_clause)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Index_clause not set");
          if (!isset_column_predicate)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Column_predicate not set");
          if (!isset_consistency_level)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Consistency_level not set");
        }
        finally
        ...
        try
        {
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              {
                oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
                foreach (KeySlice _iter149 in Success)
                {
      ...
      public void Read (TProtocol iprot)
      {
        ...
        try
        {
          ...
          if (!isset_column_parent)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Column_parent not set");
          if (!isset_column)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Column not set");
          if (!isset_consistency_level)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Consistency_level not set");
        }
        finally
    ...
    internal partial class cas_args : TBase
    {
      ...
      /// <seealso cref="ConsistencyLevel"/>
      /// </summary>
      public ConsistencyLevel Serial_consistency_level { get; set; }

      /// <summary>
      /// 
      /// <seealso cref="ConsistencyLevel"/>
      /// </summary>
      public ConsistencyLevel Commit_consistency_level { get; set; }
      ...
      public cas_args(byte[] key, string column_family, ConsistencyLevel serial_consistency_level, ConsistencyLevel commit_consistency_level) : this() {
        this.Key = key;
        this.Column_family = column_family;
      ...
      public void Read (TProtocol iprot)
      {
        ...
        try
        {
          ...
          if (!isset_serial_consistency_level)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Serial_consistency_level not set");
          if (!isset_commit_consistency_level)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Commit_consistency_level not set");
        }
        finally
        {
          iprot.DecrementRecursionDepth();
        ...
        try
        {
          ...
          if (Expected != null && __isset.expected) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (Column _iter156 in Expected)
              {
          ...
          if (Updates != null && __isset.updates) {
            ...
            oprot.WriteFieldBegin(field);
            {
              ...
              foreach (Column _iter157 in Updates)
              {
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("cas_args(");
        __sb.Append(", Key: ");
        __sb.Append(Key);
        __sb.Append(", Column_family: ");
        __sb.Append(Column_family);
        if (Expected != null && __isset.expected) {
          __sb.Append(", Expected: ");
          __sb.Append(Expected);
        }
        if (Updates != null && __isset.updates) {
          __sb.Append(", Updates: ");
        ...
        __sb.Append(", Serial_consistency_level: ");
        __sb.Append(Serial_consistency_level);
        __sb.Append(", Commit_consistency_level: ");
        __sb.Append(Commit_consistency_level);
        __sb.Append(")");
        return __sb.ToString();
      }
    ...
    internal partial class cas_result : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        ...
        try
        {
          TStruct struc = new TStruct("cas_result");
          oprot.WriteStructBegin(struc);
          TField field = new TField();
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("cas_result(");
        bool __first = true;
        if (Success != null && __isset.success) {
          if(!__first) { __sb.Append(", "); }
          __first = false;
      ...
      public void Read (TProtocol iprot)
      {
        ...
        try
        {
                ...
                if (field.Type == TType.Map) {
                  {
                    ...
                    {
                      byte[] _key160;
                      Dictionary<string, List<Mutation>> _val161;
                      _key160 = iprot.ReadBinary();
                      {
                        _val161 = new Dictionary<string, List<Mutation>>();
                        TMap _map162 = iprot.ReadMapBegin();
                        for( int _i163 = 0; _i163 < _map162.Count; ++_i163)
                        {
                          string _key164;
                          List<Mutation> _val165;
                          _key164 = iprot.ReadString();
                          {
                            _val165 = new List<Mutation>();
                            TList _list166 = iprot.ReadListBegin();
                            for( int _i167 = 0; _i167 < _list166.Count; ++_i167)
                            {
                              Mutation _elem168;
                              _elem168 = new Mutation();
                              _elem168.Read(iprot);
                              _val165.Add(_elem168);
                            }
                            iprot.ReadListEnd();
                          }
                          _val161[_key164] = _val165;
                        }
                        iprot.ReadMapEnd();
                      }
                      Mutation_map[_key160] = _val161;
                    }
                    iprot.ReadMapEnd();
                  }
          ...
          if (!isset_mutation_map)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Mutation_map not set");
          if (!isset_consistency_level)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Consistency_level not set");
        }
        finally
      ...
      public void Write(TProtocol oprot) {
        ...
        try
        {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (byte[] _iter169 in Mutation_map.Keys)
            {
              oprot.WriteBinary(_iter169);
              {
                oprot.WriteMapBegin(new TMap(TType.String, TType.List, Mutation_map[_iter169].Count));
                foreach (string _iter170 in Mutation_map[_iter169].Keys)
                {
                  oprot.WriteString(_iter170);
                  {
                    oprot.WriteListBegin(new TList(TType.Struct, Mutation_map[_iter169][_iter170].Count));
                    foreach (Mutation _iter171 in Mutation_map[_iter169][_iter170])
                    {
    ...
    internal partial class atomic_batch_mutate_args : TBase
    {
      ...
      public atomic_batch_mutate_args(Dictionary<byte[], Dictionary<string, List<Mutation>>> mutation_map, ConsistencyLevel consistency_level) : this() {
        this.Mutation_map = mutation_map;
        this.Consistency_level = consistency_level;
      }
      ...
      public void Write(TProtocol oprot) {
        ...
        try
        {
          ...
          {
            oprot.WriteMapBegin(new TMap(TType.String, TType.Map, Mutation_map.Count));
            foreach (byte[] _iter183 in Mutation_map.Keys)
            {
              oprot.WriteBinary(_iter183);
              {
                oprot.WriteMapBegin(new TMap(TType.String, TType.List, Mutation_map[_iter183].Count));
                foreach (string _iter184 in Mutation_map[_iter183].Keys)
                {
                  oprot.WriteString(_iter184);
                  {
                    oprot.WriteListBegin(new TList(TType.Struct, Mutation_map[_iter183][_iter184].Count));
                    foreach (Mutation _iter185 in Mutation_map[_iter183][_iter184])
                    {
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("atomic_batch_mutate_args(");
        __sb.Append(", Mutation_map: ");
        __sb.Append(Mutation_map);
        __sb.Append(", Consistency_level: ");
        __sb.Append(Consistency_level);
    ...
    internal partial class atomic_batch_mutate_result : TBase
    {
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("atomic_batch_mutate_result(");
        bool __first = true;
        if (Ire != null && __isset.ire) {
          if(!__first) { __sb.Append(", "); }
          __first = false;
    ...
    internal partial class truncate_args : TBase
    {
      ...
      public void Read (TProtocol iprot)
      {
        ...
        try
        {
          ...
          iprot.ReadStructEnd();
          if (!isset_cfname)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Cfname not set");
        }
        finally
        {
          iprot.DecrementRecursionDepth();
    ...
    internal partial class get_multi_slice_args : TBase
    {
      ...
      public get_multi_slice_args(MultiSliceRequest request) : this() {
      ...
      public void Read (TProtocol iprot)
      {
        ...
        try
        {
          ...
          iprot.ReadStructEnd();
          if (!isset_request)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Request not set");
        }
        finally
        {
          iprot.DecrementRecursionDepth();
      ...
      public void Write(TProtocol oprot) {
        ...
        try
        {
          TStruct struc = new TStruct("get_multi_slice_args");
          oprot.WriteStructBegin(struc);
          TField field = new TField();
          if (Request == null)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Request not set");
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("get_multi_slice_args(");
        __sb.Append(", Request: ");
    ...
    internal partial class get_multi_slice_result : TBase
    {
                ...
                if (field.Type == TType.List) {
                  {
                    ...
                    {
                      ColumnOrSuperColumn _elem188;
                      _elem188 = new ColumnOrSuperColumn();
                      _elem188.Read(iprot);
      ...
      public void Write(TProtocol oprot) {
        ...
        try
        {
          TStruct struc = new TStruct("get_multi_slice_result");
          oprot.WriteStructBegin(struc);
          TField field = new TField();
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              {
                oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
                foreach (ColumnOrSuperColumn _iter189 in Success)
                {
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("get_multi_slice_result(");
        bool __first = true;
        if (Success != null && __isset.success) {
          if(!__first) { __sb.Append(", "); }
          __first = false;
        ...
        try
        {
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              {
                oprot.WriteMapBegin(new TMap(TType.String, TType.List, Success.Count));
                foreach (string _iter197 in Success.Keys)
                {
                  oprot.WriteString(_iter197);
                  {
                    oprot.WriteListBegin(new TList(TType.String, Success[_iter197].Count));
                    foreach (string _iter198 in Success[_iter197])
                    {
        ...
        try
        {
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              {
                oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
                foreach (KsDef _iter202 in Success)
                {
        ...
        try
        {
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              {
                oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
                foreach (TokenRange _iter206 in Success)
                {
    ...
    internal partial class describe_local_ring_args : TBase
    {
      ...
      public describe_local_ring_args(string keyspace) : this() {
        this.Keyspace = keyspace;
      }
      ...
      public void Write(TProtocol oprot) {
        ...
        try
        {
          TStruct struc = new TStruct("describe_local_ring_args");
          oprot.WriteStructBegin(struc);
          TField field = new TField();
          if (Keyspace == null)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Keyspace not set");
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("describe_local_ring_args(");
        __sb.Append(", Keyspace: ");
        __sb.Append(Keyspace);
        __sb.Append(")");
        return __sb.ToString();
    ...
    internal partial class describe_local_ring_result : TBase
    {
      ...
      public void Write(TProtocol oprot) {
        ...
        try
        {
          TStruct struc = new TStruct("describe_local_ring_result");
          oprot.WriteStructBegin(struc);
          TField field = new TField();
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              {
                oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
                foreach (TokenRange _iter210 in Success)
                {
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("describe_local_ring_result(");
        bool __first = true;
        if (Success != null && __isset.success) {
          if(!__first) { __sb.Append(", "); }
          __first = false;
    ...
    internal partial class describe_token_map_args : TBase
    {
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("describe_token_map_args(");
        __sb.Append(")");
        return __sb.ToString();
      }
    ...
    internal partial class describe_token_map_result : TBase
    {
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              oprot.WriteFieldBegin(field);
              {
                ...
                foreach (string _iter215 in Success.Keys)
                {
                  oprot.WriteString(_iter215);
                  oprot.WriteString(Success[_iter215]);
                }
                oprot.WriteMapEnd();
              }
              oprot.WriteFieldEnd();
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("describe_token_map_result(");
        bool __first = true;
        if (Success != null && __isset.success) {
          if(!__first) { __sb.Append(", "); }
          __first = false;
      ...
      public void Read (TProtocol iprot)
      {
        ...
        try
        {
          ...
          if (!isset_keys_per_split)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Keys_per_split not set");
        }
        finally
        {
          iprot.DecrementRecursionDepth();
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              oprot.WriteFieldBegin(field);
              {
                ...
                foreach (string _iter219 in Success)
                {
    ...
    internal partial class trace_next_query_args : TBase
    {
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("trace_next_query_args(");
        __sb.Append(")");
        return __sb.ToString();
      }
    ...
    internal partial class trace_next_query_result : TBase
    {
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("trace_next_query_result(");
        bool __first = true;
        if (Success != null && __isset.success) {
          if(!__first) { __sb.Append(", "); }
          __first = false;
    ...
    internal partial class describe_splits_ex_args : TBase
    {
      ...
      public describe_splits_ex_args(string cfName, string start_token, string end_token, int keys_per_split) : this() {
        this.CfName = cfName;
        this.Start_token = start_token;
        this.End_token = end_token;
        this.Keys_per_split = keys_per_split;
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("describe_splits_ex_args(");
        __sb.Append(", CfName: ");
        __sb.Append(CfName);
        __sb.Append(", Start_token: ");
        __sb.Append(Start_token);
    ...
    internal partial class describe_splits_ex_result : TBase
    {
        ...
        try
        {
          ...
          if (this.__isset.success) {
            if (Success != null) {
              ...
              {
                oprot.WriteListBegin(new TList(TType.Struct, Success.Count));
                foreach (CfSplit _iter223 in Success)
                {
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("describe_splits_ex_result(");
        bool __first = true;
        if (Success != null && __isset.success) {
          if(!__first) { __sb.Append(", "); }
          __first = false;
    ...
    internal partial class system_add_column_family_args : TBase
    {
      ...
      public void Read (TProtocol iprot)
      {
        ...
        try
        {
          ...
          iprot.ReadStructEnd();
          if (!isset_cf_def)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Cf_def not set");
        }
        finally
        {
          iprot.DecrementRecursionDepth();
    ...
    internal partial class system_add_keyspace_args : TBase
    {
      ...
      public void Read (TProtocol iprot)
      {
        ...
        try
        {
          ...
          iprot.ReadStructEnd();
          if (!isset_ks_def)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Ks_def not set");
        }
        finally
        {
          iprot.DecrementRecursionDepth();
    ...
    internal partial class execute_cql_query_args : TBase
    {
      ...
      public void Read (TProtocol iprot)
      {
        ...
        try
        {
          ...
          iprot.ReadStructEnd();
          if (!isset_query)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Query not set");
          if (!isset_compression)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Compression not set");
        }
        finally
        {
          iprot.DecrementRecursionDepth();
    ...
    internal partial class execute_cql3_query_args : TBase
    {
      ...
      public execute_cql3_query_args(byte[] query, Compression compression, ConsistencyLevel consistency) : this() {
        this.Query = query;
        this.Compression = compression;
      ...
      public void Read (TProtocol iprot)
      {
        ...
        try
        {
          ...
          if (!isset_consistency)
            throw new TProtocolException(TProtocolException.INVALID_DATA, "required field Consistency not set");
        }
        finally
        {
          iprot.DecrementRecursionDepth();
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("execute_cql3_query_args(");
        __sb.Append(", Query: ");
        __sb.Append(Query);
        __sb.Append(", Compression: ");
        __sb.Append(Compression);
        __sb.Append(", Consistency: ");
        __sb.Append(Consistency);
        __sb.Append(")");
        return __sb.ToString();
      }
    ...
    internal partial class execute_cql3_query_result : TBase
    {
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("execute_cql3_query_result(");
        bool __first = true;
        if (Success != null && __isset.success) {
          if(!__first) { __sb.Append(", "); }
          __first = false;
    ...
    internal partial class prepare_cql3_query_args : TBase
    {
      ...
      public prepare_cql3_query_args(byte[] query, Compression compression) : this() {
        this.Query = query;
        this.Compression = compression;
      }
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("prepare_cql3_query_args(");
        __sb.Append(", Query: ");
        __sb.Append(Query);
        __sb.Append(", Compression: ");
        __sb.Append(Compression);
    ...
    internal partial class prepare_cql3_query_result : TBase
    {
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("prepare_cql3_query_result(");
        bool __first = true;
        if (Success != null && __isset.success) {
          if(!__first) { __sb.Append(", "); }
          __first = false;
    ...
    internal partial class execute_prepared_cql_query_args : TBase
    {
      ...
      public execute_prepared_cql_query_args(int itemId, List<byte[]> values) : this() {
        this.ItemId = itemId;
        this.Values = values;
      }
      ...
      public void Write(TProtocol oprot) {
        ...
        try
        {
          ...
          oprot.WriteFieldBegin(field);
          {
            ...
            foreach (byte[] _iter227 in Values)
            {
    ...
    internal partial class execute_prepared_cql3_query_args : TBase
    {
      ...
      public execute_prepared_cql3_query_args(int itemId, List<byte[]> values, ConsistencyLevel consistency) : this() {
        this.ItemId = itemId;
        this.Values = values;
        this.Consistency = consistency;
      }
      ...
      public void Write(TProtocol oprot) {
        ...
        try
        {
          ...
          {
            oprot.WriteListBegin(new TList(TType.String, Values.Count));
            foreach (byte[] _iter231 in Values)
            {
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("execute_prepared_cql3_query_args(");
        __sb.Append(", ItemId: ");
        __sb.Append(ItemId);
        __sb.Append(", Values: ");
        __sb.Append(Values);
    ...
    internal partial class execute_prepared_cql3_query_result : TBase
    {
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("execute_prepared_cql3_query_result(");
        bool __first = true;
        if (Success != null && __isset.success) {
          if(!__first) { __sb.Append(", "); }
          __first = false;
    ...
    internal partial class set_cql_version_args : TBase
    {
      ...
      public set_cql_version_args(string version) : this() {
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("set_cql_version_args(");
        __sb.Append(", Version: ");
        __sb.Append(Version);
        __sb.Append(")");
        return __sb.ToString();
    ...
    internal partial class set_cql_version_result : TBase
    {
      ...
      public override string ToString() {
        StringBuilder __sb = new StringBuilder("set_cql_version_result(");
        bool __first = true;
        if (Ire != null && __isset.ire) {
          if(!__first) { __sb.Append(", "); }
          __first = false;
