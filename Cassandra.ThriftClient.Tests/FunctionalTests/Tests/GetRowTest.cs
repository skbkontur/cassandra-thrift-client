    ...
    public class GetRowTest : CassandraFunctionalTestBase
    {
        ...
        public void TestGetFullRow()
        {
            ...
            for (var i = 0; i < columns.Length; i++)
            {
                ...
                var columnValue = "columnValue" + i;
                columns[i] = ToColumn(columnName, columnValue, 100);
                columnFamilyConnection.AddColumn("row", columns[i]);
            }
            var actualColumns = columnFamilyConnection.GetRow("row", 10).ToArray();
        ...
        public void TestGetAllRows()
        {
            ...
            var actualRows = columnFamilyConnection.GetKeys(10).ToArray();
        ...
        public void TestGetRow()
        {
            ...
            var actualColumns = columnFamilyConnection.GetColumns("row", null, 4);
        ...
        public void TestGetRowSmallCount()
        {
            ...
            var actualColumns = columnFamilyConnection.GetColumns("row", null, 3);
        ...
        public void TestGetRowExclusiveFirstColumn()
        {
            ...
            var column = ToColumn(columnName, columnValue, timestamp);
            ...
            var actualColumns = columnFamilyConnection.GetColumns(key, column.Name, 1);
        ...
        public void TestGetRowExclusiveFirstColumnWithReversed()
        {
            ...
            var actualColumns = columnFamilyConnection.GetColumns("row", "columnName3", 2, true);
        ...
        public void TestGetColumnsFormSlice()
        {
            ...
            var actualColumns = columnFamilyConnection.GetColumns("row", "columnName3", "columnName8", 3);
            Assert.AreEqual(3, actualColumns.Length);
            for (var i = 0; i < 3; i++)
        ...
        public void TestGetColumnsFormSliceWithNoExistenceEndColumn()
        {
            ...
            var actualColumns = columnFamilyConnection.GetColumns("row", "columnName3", "columnName8", 50);
            Assert.AreEqual(3, actualColumns.Length);
            for (var i = 0; i < 3; i++)
                actualColumns[i].AssertEqualsTo(columns[i + 3]);
        }
        ...
        public void TestGetColumnsFormSliceReversed()
        {
            ...
            var actualColumns = columnFamilyConnection.GetColumns("row", "columnName8", "columnName3", 3, true);
            Assert.AreEqual(3, actualColumns.Length);
            for (var i = 0; i < 3; i++)
            {
        ...
        public void TestGetRowReturnLessThanQuery()
        {
            ...
            var actualColumns = columnFamilyConnection.GetColumns(key, columns[0].Name, 4);
            Assert.AreEqual(3, actualColumns.Length);
            for (var i = 0; i < 3; i++)
        ...
        public void TestGetFirstColumns()
        {
            ...
            var actualColumns = columnFamilyConnection.GetColumns(key, "columnName", 4);
        ...
        public void TestGetRowFrom20()
        {
            ...
            for (var i = 0; i < columns.Length; i++)
            {
                var columnName = "columnName" + i.ToString("D3");
                var columnValue = "columnValue" + i;
                columns[i] = ToColumn(columnName, columnValue, 100);
            }
